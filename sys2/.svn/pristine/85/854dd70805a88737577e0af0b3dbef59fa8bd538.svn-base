 ...
 * * 1.8.1
 * * * Bugfix for broken pagination in ie6 and 7: Selector and object access modified by Daniel K鰊t鰏 (www.MilkmanMedia.de). Thanks to Carolin Moll for the report.
 * * 1.8.2
