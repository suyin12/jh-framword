...
<table id="displayTable" width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#666666">
		...
		<td class="edit"><a href='../workerInfo.php<? echo "?"; ?>sessionID=<?php echo $rows['sessionID'];?>&IDNumber=<?php echo $rows['field7'];?>' target='_top'><? echo $rows['field6']; ?></a></td>
        ...
        <td class="edit"><a href='../editWorker.php<? echo "?"; ?>editId=<?php echo $rows['ID'];?>&sessionID=<?php echo $rows['sessionID'];?>' target="_top">编辑</a></td>
