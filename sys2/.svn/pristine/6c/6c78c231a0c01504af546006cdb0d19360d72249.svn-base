...
<script type="text/javascript">
    ...
    $(document).ready(function(){
		...
		mulChangeVal("uSoInsS");
        mulChangeVal("uHFS");
        mulChangeVal("uComInsS");
        mulChangeVal("managementCostS");
        mulChangeVal("uPDInsS");
    ...
    //鼠标离开应收费用时改变
        ...
        $("input[name=closeRefresh]").click(function(){
            top.location.href = "makeFee_mul.php" + location.search;
        });
                ...
                <form id="uSoInsEditFeeForm" name="uSoInsEditFeeForm">
                    ...
                    <table class="myTable">
                        <thead>
                            ...
                            <tr>
                                <th>本月应收<br>
                                <input name="muluSoInsS" type="text" size=5 />
                                </th>								
                                <th>本月实收</th>
                                <th>冲减挂账</th>
                                <th>应收欠款</th>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td colspan="4">
                                    <input type="button" name="setMoney_mul" class="sub" value="将均衡值设置为欠/挂记录">
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <form id="uHFEditFeeForm" name="uHFEditFeeForm">
                    ...
                    <table class="myTable">
                        <thead>
                            ...
                            <tr>
                                <th>本月应收<br><input name="muluHFS" type="text" size=5 /></th>
                                <th>本月实收</th>
                                <th>冲减挂账</th>
                                <th>应收欠款</th>
                                <th>收回欠款</th>
            ...
            <form id="uComInsEditFeeForm" name="uComInsEditFeeForm">
                ...
                <table class="myTable">
                    <thead>
                        ...
                        <tr>
                            <th>本月应收<br><input name="muluComInsS" type="text" size=5 /></th>
                               <th>本月实收</th>
                            <th>冲减挂账</th>
                            <th>应收欠款</th>
                            <th>收回欠款</th>
            ...
            <form id="mCostEditFeeForm" name="mCostEditFeeForm">
                ...
                <table class="myTable">
                    <thead>
                        ...
                        <tr>
                              <th>本月应收<br><input name="mulmanagementCostS" type="text" size=5 /></th>
                               <th>本月实收</th>
                            <th>冲减挂账</th>
                            <th>应收欠款</th>
                            <th>收回欠款</th>
            ...
            <form id="uPDInsEditFeeForm" name="uPDInsEditFeeForm">
                ...
                <table class="myTable">
                    <thead>
                        ...
                        <tr>
                             <th>本月应收<br><input name="muluPDInsS" type="text" size=5 /></th>
                               <th>本月实收</th>
                            <th>冲减挂账</th>
                            <th>应收欠款</th>
                            <th>收回欠款</th>
