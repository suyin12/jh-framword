...
$reSql = "select a.ID,a.uID,b.name,a.uHFMoney,a.pHFMoney,a.type from `a_prsRequireMoney` a left join `a_workerInfo` b on a.uID = b.uID where a.month like :month and a.unitID like :unitID and ( uHFMoney<>0 or pHFMoney<>0) and b.uID is not null  ";
#这里就做个EXCEL筛选模式..
...
$smarty->assign ( array (
		"uHFMoneyArr" => $uHFMoneyArr,
		"pHFMoneyArr" => $pHFMoneyArr,
		"typeArr" => $typeArr 
) );
...
$smarty->display ( "approval/HFBalFeeApproval.tpl" );
?>
