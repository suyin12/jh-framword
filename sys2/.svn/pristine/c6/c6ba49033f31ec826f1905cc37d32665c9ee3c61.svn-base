...
class balance_basicFeeMulInsert
{
    ...
    public function field()
    {
        ...
        $field = array( "unitName", "name", "pID", "uSoInsTotal", "pSoInsTotal", "HFTotal", "NULL1", "uSoInsSecTotal", "pSoInsSecTotal", "HFSecTotal","NULL2","NULL3","NULL4","feeID","mCost","mCostSec");
        $trueField = array("unitName", "name", "pID","soInsTotal","soInsSecTotal","HFTotal","mCost","feeID");
        $extraEngToChsArr=array("soInsTotal"=>"社保合计","soInsSecTotal"=>"社保补缴合计","HFTotal"=>"公积金合计","feeID"=>"账套名称");
