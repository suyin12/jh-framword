...
echo $managerSql="select * from cwps_user where SubGroupIDs=',14,'";
...
//        alert(URL);
 ...
 $(document).ready(function() {
	   var sWidth = Math.max(document.body.scrollWidth, document.body.clientWidth)*0.95;
	   var sHeight = Math.max(document.body.scrollHeight, document.body.clientHeight)*0.95;
