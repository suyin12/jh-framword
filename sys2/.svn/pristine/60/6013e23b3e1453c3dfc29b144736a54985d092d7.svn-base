...
<script type="text/javascript" src={$httpPath}theme/lib/js/select.js></script>
...
<form class="ideal-form" id="s1_form">
    <section name="基本信息" id="s1">
        ...
        <table id="basicInfo" class="myTable">
            ...
            <tr>
                <td>配偶姓名:</td>
                <td><input type="text" name="spouseName" id="spouseName" value="{$wInfo.spouseName}"/></td>
                <td>配偶身份证号码:</td>
                <td><input type="text" name="spousePID" id="spousePID" value="{$wInfo.spousePID}"/></td>
