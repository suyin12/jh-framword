...
<?php if (have_posts()) : the_post(); update_post_caches($posts); ?>
        <div id="postpath">
          <a title="<?php _e('Go to homepage', 'budeyan'); ?>" href="<?php echo get_settings('home'); ?>/"><?php _e('Home', 'budeyan'); ?></a> &gt; <?php the_title(); ?></div>
        <div class="post" id="post-<?php the_ID(); ?>">
          ...
          <div class="content">
            <?php wp_tag_cloud('smallest=10&largest=22&unit=pt&order=rand&number=5000'); ?>
            <div class="fixed"></div>
          </div>
        </div>
