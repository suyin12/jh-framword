			...
			success: function (res) {
				...
				$.get(SITE_URL+"/index.php?s=/Home/Weixin/downloadPic/media_id/"+res.serverId+".html",function(data){
					...
					if(data.result=="success"){						
						if(num>1 && le<(num+1)){
							var addImg = $('<div class="img_item" style="width:30%;height:6.8em;float: left;margin-left:2.4%; margin-bottom:10%;"><em style="display:block;width:15%; "><img style="width:100%;height:100%;" src="/weixin/Public/static/WorkerService/del.png" alt=""></em><input type="hidden" name="'+name+'" value="'+data.id+'"/><img style="width:100%;height:100%;" src="'+data.picUrl+'"/></div>');
							...
							// $('#upload_u').css({'margin-top':'4.5%','width':'25%','height':'5em'});
							$('#upload_u').css({'width':'30%','height':'6.8em'});
