...
return array(
		// 数据库配置
        'DB_TYPE'   => 'mysql', // 数据库类型
        'DB_HOST'   => '120.24.162.213', // 服务器地址120.24.162.213//192.168.0.8
        'DB_NAME'   => 'tempsys', // 数据库名//testdispatchsys
        'DB_USER'   => 'root', // 用户名
        'DB_PWD'    => '1qa2WS3ed4RF',  // 密码
        'DB_PORT'   => '3306', // 端口
		...
		// 系统数据加密设置
		'DATA_AUTH_KEY' => 'i5"CdaA@0b&U#Is8<$=guc(vwJm]PMNK3>+EnWH,', // 默认数据加密KEY
		...
		'UPLOAD_QINIU_CONFIG' => array (
				'accessKey' => '1uxZRWY4FnbCVez1SmlTbqr3GfLSaLPp97VEtoL-',
				'secrectKey' => 'N7goDAc1TNNZtT_yqWH6M7xu1ffVq5zJTi1cNQxs',
				'bucket' => 'weishi',
				'domain' => '7teaoa.com1.z0.glb.clouddn.com',
				'timeout' => 3600 
		),
