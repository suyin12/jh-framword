...
<body onLoad="inSel()">
	...
	<div align="center">
	年份：<select name ="selYear" style="background-color:#E6F3FF;height:21px;width:120px;">
		<option value="2007">2007</option>
		<option value="2008">2008</option>
		<option value="2009">2009</option>
		<option value="2010">2010</option>
	</select>
	月份：<select name ="selMothon" style="background-color:#E6F3FF;height:21px;width:120px;">
	...
	发布人：
	<select name="selcolumn" style="background-color:#E6F3FF;height:21px;width:120px;">
	...
	<br />
	 <?php 
			...
			echo "<table border='1'   cellpadding='1' cellspacing='1'  style='width:600px'>";
