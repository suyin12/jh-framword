...
include_once ("./includesWorker.inc");
//include_once ("./settings.inc");
...
<tr>
<td width="100%"><font color="#FFFFFF" size="+2">导入员工花名册</font></td>
</tr>
</table>
...
if ( $_POST['step'] == 2 ) { // Adding data into mysql (step 2)
	...
	$alterTable="alter table $db_table add ID int(20)  PRIMARY KEY auto_increment not null";
...
//	}
	if ( empty ($err) ) {
		...
		<br><a href="indexWorker.php">继续</a>
...
//		}
	...
	else 	echo "<br><br><font color=\"red\">$err</font><br><br><div align=\"center\"><a href=\"indexWorker.php\">继续</a></div>";
