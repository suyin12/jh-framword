...
*html .main { position:absolute; left:200px; top:80px; bottom:0px; right:0px; overflow:auto;}
/**html .bottom { position:absolute; left:5px; bottom:5px; right:5px; height:30px;}
*/
*html html { _padding:70px 10px;} /* www.codefans.net */
*html .top {  width:101.6%; _height:70px; _margin-top:-65px; _margin-bottom:5px; _position:relative; _top:-5px; _right:0px; _bottom:0; _left:-10px;}
*html .side { _height:109.7%; _float:left; _width:230px; _position:relative; _top:-5px; _right:0; _bottom:20; _left:-5px;}
*html .main {float:right; _width:82.3%; _height:111%; _margin-left:-30px; _position:relative; _top:-5px; _right:-100px; _bottom:0; _left:10px;}
...
*+html .main {  left:240px; top:650px; bottom:0px; right:0px; overflow:auto;}
/**+html .bottom { position:absolute; left:5px; bottom:5px; right:5px; height:30px;}*/
*+html html { _padding:70px 10px;} /* www.codefans.net */
...
<?php } else {} ?>
      ...
      <li><img src="/publish/OA/css/images/folder.gif" />员工信息管理
        <ul>
          ...
          <li><img src="/publish/OA/css/images/file.gif" /><a href="workerManager/fixedWorker.php" class="link">员工信息查询 </a></li>
