	...
	public function page_list($link=""){
		...
		Switch ($page_num) {
			...
			Case $this->pagecount :
			    ...
			    if($this->pagecount==0)$index_page=$prev_page="";
			Break;
			Default:
				$index_page="<a href=".$link."page=1>首页&nbsp;</a>";
			    $prev_page="<a href=".$link."page=".($page_num-1).">上一页&nbsp;</a>";
...
//			}
//		}
		echo "共<span class='count' name='count' id='count'>".$this->count."</span>条记录&nbsp;".$page_num."/".$this->pagecount."页&nbsp;".$index_page.$prev_page.$temppage.$next_page.$end_page;
	}
}
?>