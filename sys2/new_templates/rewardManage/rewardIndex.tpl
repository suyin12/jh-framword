                            ...
                            {foreach item=unitList from=$unit}
                                {if $s_unitID eq $unitList.unitID}
                                    <tr>
                                        ...
                                        <td>
                                            {foreach item=list from=$ret}
                                                {if $list.unitID eq $unitList.unitID}
                                                    <a href="{$httpPath|cat:'rewardManage/rewardManage.php?zID='|cat:$list.zID|cat:'&month='|cat:$list.month}&unitID={$list.unitID}" target="_blank">{$list.month|substr:4}	月</a> 	 |
                                                {/if}
                                            {/foreach}
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="button" dataSrc="{$httpPath}salaryManage/salaryZFChose.php?mID={$manager.mID}&unitID={$unitList.unitID}&process=reward" class="createFee"  value="新费用">
                                        </td>
                                    </tr>
                                {elseif !$s_unitID}
                                    <tr>
