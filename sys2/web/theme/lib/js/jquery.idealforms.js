...
$.idealforms.errors = {
  ...
  email: '璇疯緭鍏ユ湁鏁堢殑閭. <em>(e.g. user@gmail.com)</em>',
  phone: '璇疯緭鍏ユ偍鐨勮仈绯荤數璇? <em>(e.g. 13412345621)</em>',
  emphone:'璇疯緭鍏ョ揣鎬ヨ仈绯荤數璇?<em>(e.g.瀹跺涵鐢佃瘽鎴栨墜鏈哄彿鐮?</em>',
...
var getFilters = function() {
  ...
  var filters = {
    ...
    emphone:{
        regex:/^\d{11}$|^(\d{3,4}-)\d{7,8}$/,
        error:$.idealforms.errors.emphone
    },
    zip: {
      regex: /^\d{5}$|^\d{5}-\d{4}$/,
