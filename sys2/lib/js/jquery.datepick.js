...
function Datepicker() {
	...
	this.regional = {
		'': { // US/English
			...
			prevStatus: '显示上一个月', // Status text for the previous month command
			prevJumpText: '<<', // Text for the previous year command
			prevJumpStatus: '显示上一年', // Status text for the previous year command
			nextText: '下月>', // Text for the next month command
			nextStatus: '显示下一个月', // Status text for the next month command
			nextJumpText: '>>', // Text for the next year command
			nextJumpStatus: '显示下一年', // Status text for the next year command
			currentText: 'Current', // Text for the current month command
			currentStatus: '显示当前月份', // Status text for the current month command
			todayText: '本月', // Text for the today's month command
			todayStatus: '显示当前月份', // Status text for the today's month command
			clearText: '清除', // Text for the clear command
			clearStatus: '清除已选择的日期', // Status text for the clear command
			closeText: '关闭', // Text for the close command
			closeStatus: '关闭日期选择器', // Status text for the close command
			yearStatus: '改变年份', // Status text for year selection
			monthStatus: '改变月份', // Status text for month selection
